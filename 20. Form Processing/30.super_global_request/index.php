<?php
  ...
  if (isset($_REQUEST["submit"])) {
    ...
    $nama   = htmlentities(strip_tags(trim($_REQUEST["nama"])));
    $email  = htmlentities(strip_tags(trim($_REQUEST["email"])));
    $buku   = htmlentities(strip_tags(trim($_REQUEST["buku"])));
    $jumlah = htmlentities(strip_tags(trim($_REQUEST["jumlah"])));
    $alamat = htmlentities(strip_tags(trim($_REQUEST["alamat"])));
    $kurir  = htmlentities(strip_tags(trim($_REQUEST["kurir"])));
    $ongkir = htmlentities(strip_tags(trim($_REQUEST["ongkir"])));
    $tgl    = htmlentities(strip_tags(trim($_REQUEST["tgl"])));
    $bln    = htmlentities(strip_tags(trim($_REQUEST["bln"])));
    $thn    = htmlentities(strip_tags(trim($_REQUEST["thn"])));
